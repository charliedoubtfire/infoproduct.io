...
export const COMPARISON: ComparisonRow[] = [
  ...
  { topic: 'VSL Scripting AI', competition: false },
  { topic: 'Founder Wrote VSL', competition: false },
  { topic: 'How to build a highly converting Site Copy', competition: true },
  { topic: 'Site Copy AI', competition: false },
  { topic: 'How to curate your branding and live rent-free in your audience’s mind', competition: false },
  { topic: 'Email Copywriting Training', competition: true },
  { topic: 'Email Copywriting AI', competition: false },
  { topic: 'Basic Marketing Plan Guidelines', competition: true },
  { topic: 'Scientific Marketing Plan AI', competition: false },
  { topic: 'YouTube Video Structure', competition: true },
  { topic: 'YouTube Video Script AI', competition: false },
  { topic: 'YouTube Title Strategies', competition: true },
  { topic: 'YouTube Title AI', competition: false },
  { topic: 'How to learn basic camera skills', competition: true },
  { topic: 'How to master oration', competition: false },
  { topic: 'Basic Sales Training', competition: true },
  { topic: 'Text-Based Sales Training', competition: false },
  {
    topic:
      'Advanced Sales Training (lessons from top closers inside the most successful infoproduct operations of all time)',
    competition: false,
  },
  { topic: 'How to build a Team of A-Players', competition: false },
  { topic: 'How to lead your team', competition: true },
